...
export function Footer() {
  return (
    <footer id="footer" className="relative bg-anthracite pt-20 text-cream">
          ...
          <div className="flex flex-wrap gap-10 sm:gap-16">
            <div>
              ...
              <ul className="mt-4 flex flex-col gap-2.5 text-sm text-cream/70">
                <li><a href="#storia" className="transition-colors hover:text-pasta-yellow">Storia</a></li>
                <li><a href="#numeri" className="transition-colors hover:text-pasta-yellow">I Numeri</a></li>
                <li><a href="#ricette" className="transition-colors hover:text-pasta-yellow">Ricette</a></li>
              </ul>
            </div>
            <div>
              <span className="text-sm font-semibold uppercase tracking-[0.15em] text-cream/50">Azienda</span>
              <ul className="mt-4 flex flex-col gap-2.5 text-sm text-cream/70">
                <li><a href="#top" className="transition-colors hover:text-pasta-yellow">Chi siamo</a></li>
                <li><a href="#footer" className="transition-colors hover:text-pasta-yellow">Contatti</a></li>
              </ul>
            </div>
          </div>
        </div>
